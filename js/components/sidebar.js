...
const NAV_ITEMS = [
  { id: 'my-profile', label: 'Mon profil',     icon: '👤', shareOnly: true },
  ...
  container.innerHTML = `
    <div class="sidebar">
      ...
      <nav class="sidebar__nav">
        ...
        ${NAV_ITEMS
          .filter(item => {
            if (item.shareOnly && !isShareMode()) return false;
            if (!isShareMode()) return !item.shareOnly;
            return ['matrix', 'dashboard', 'radar', 'settings', 'my-profile'].includes(item.id);
          })
          .map(item => `
      ...
      <div class="sidebar__bottom">
        ...
        <div class="sidebar__footer">
          <a href="https://github.com/sebastien-rouen/skills-matrix" target="_blank" rel="noopener"
            ...
            <span>Skills Matrix v2.1.0</span>
          </a>
        </div>
      </div>
    </div>
